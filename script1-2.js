            ...
            bindClickHandlers() {
                ...
                $("body").on("click", ".qlink.load_afo", () => {
                    if (typeof this.afo_is_loaded == 'undefined') {
                        ...
                        $.get("https://raw.githubusercontent.com/SWAssistant1/SWAssistant/main/uncodedeeee.js", (data) => {
